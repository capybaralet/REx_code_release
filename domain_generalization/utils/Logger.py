...
class Logger():
    ...
    def get_name_from_args(args):
        ...
        name = "eps%d_bs%d_lr%g_class%d_jigClass%d_rexWeightClass%g_rexWeightJig%g_irmWeightClass%g_irmWeightJig%g_jigWeight%g" % (args.epochs, args.batch_size, args.learning_rate, args.n_classes,
                                                                   args.jigsaw_n_classes, args.rex_weight_class, args.rex_weight_jigsaw, args.rex_weight_class, args.rex_weight_jigsaw, args.jig_weight)
